...
const fr: Translations = {
  ...
  vehicleCatalog: {
    ...
    filters: "Filtres",
    filtersHelper: "Combinez les filtres pour trouver le véhicule qui correspond le mieux à votre voyage.",
    resultsFound: "Véhicules trouvés",
    resultsOutOf: "sur le total disponible",
    ...
    filterHistory: "Historique des filtres",
    historyEmpty: "Interagissez avec les filtres pour voir votre activité ici.",
    historySearch: "Recherche mise à jour en",
    historyCategory: "Catégorie définie sur",
    historyPrice: "Plage de prix mise à jour",
    historySeats: "Nombre minimum de sièges ajusté à",
    historySearchCleared: "Recherche effacée",
    historyCategoryCleared: "Catégorie réinitialisée",
    historyPriceCleared: "Plage de prix réinitialisée",
    historySeatsCleared: "Filtre de sièges supprimé",
    historyAllCleared: "Tous les filtres réinitialisés",
  },
  reservationForm: {
    ...
    cancel: "Annuler",
    summaryTitle: "Suivi de la réservation",
